...
.constant("ENV", {
	"/": {
		"k8sApiServer": "http://192.168.1.2:8080/api/v1beta2",
		"k8sApiv1beta3Server": "http://192.168.1.2:8080/api/v1beta3",
		"k8sDataServer": "/cluster",
		"k8sDataPollMinIntervalSec": 10,
		"k8sDataPollMaxIntervalSec": 120,
		"k8sDataPollErrorThreshold": 5,
		"cAdvisorProxy": "http://192.168.1.2:8080/api/v1beta3/proxy/nodes/",
		"cAdvisorPort": "4194"
	}
})
...
app.provider('k8sv1Beta3Api',
    ...
    .config(["k8sv1Beta3ApiProvider", "ENV", function(k8sv1Beta3ApiProvider, ENV) {
      if (ENV && ENV['/'] && ENV['/']['k8sApiv1beta3Server']) {
        k8sv1Beta3ApiProvider.setUrlBase(ENV['/']['k8sApiv1beta3Server']);
      }
    }]);
